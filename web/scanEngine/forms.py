...
from paraKang.validators import validate_short_name
...
class AddEngineForm(forms.ModelForm):
    class Meta:
        model = EngineType
        # MED-24 fix: Explicit fields instead of '__all__'
        fields = ['engine_name', 'yaml_configuration', 'default_engine']
...
class ConfigurationForm(forms.ModelForm):
    class Meta:
        model = Configuration
        # MED-24 fix: Explicit fields instead of '__all__'
        fields = ['name', 'short_name', 'content']
    name = forms.CharField(
        required=True,
        widget=forms.TextInput(
            attrs={'class': 'form-control form-control-lg',
...
class ReportForm(forms.ModelForm):
    ...
    show_parakang_banner = forms.BooleanField(
        required=False,
        widget=forms.CheckboxInput(
            attrs={
                "class": "form-check-input",
                "id": "show_parakang_banner",
            }))
    ...
    def set_value(self, key):
        ...
        self.initial['show_parakang_banner'] = key.show_parakang_banner
    ...
    def set_initial(self):
        self.initial['show_parakang_banner'] = True
...
**{company_name}** performed both Security Audit and Reconnaissance using automated tool paraKang. https://github.com/mamanwhide/paraKang .
