...
NUCLEI_EXCLUDE_TEMPLATES = 'exclude_templates'
...
FFUF_DEFAULT_MATCH_HTTP_STATUS = [200, 204, 301, 302, 307, 308, 401, 403, 405]
...
# NOTE: Each extension multiplies the wordlist size.
# With dicc.txt (~26K words) and 19 extensions = 26K × 20 = 520K requests per URL.
# With recursion, this grows exponentially. Consider reducing extensions for speed.
