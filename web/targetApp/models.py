...
class DomainInfo(models.Model):
	...
	# registrar
	# SEC-09 fix: SET_NULL instead of CASCADE to prevent data loss
	registrar = models.ForeignKey(Registrar, blank=True, on_delete=models.SET_NULL, null=True)
	# registrant
...
class Domain(models.Model):
	...
	description = models.TextField(blank=True, null=True)
	insert_date = models.DateTimeField(null=True, default=timezone.now)
