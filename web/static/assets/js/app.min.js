        ...
        n(".navbar-nav a").each(function () {
          ...
          if (this.href == t) {
            if (
              ...
              n(this).parent().parent().parent().parent().hasClass("mega-dropdown-menu"))
            )
              n(this).parent().parent().parent().parent().parent().addClass("active"), n(this).parent().parent().parent().parent().parent().parent().addClass("active");
            else {
      ...
      (t.prototype.init = function () {
        ...
        i(document).on("click", ".right-bar-toggle", function () {
          ...
          i(document).on("click", "body", function (t) {
            1 !== i(t.target).closest("#top-search").length && i("#search-dropdown").removeClass("d-block"),
          ...
          i("#dark-mode-check").change(function () {
            if (this.checked) {
              localStorage.setItem("parakang-theme","dark");
              e.layout.changeMode("dark", !0), e.selectOptionsFromConfig();
            }
            else {
              localStorage.setItem("parakang-theme",null);
              e.layout.changeMode("light", !0), e.selectOptionsFromConfig();
            }
          }),
  ...
  (function (n) {
    ...
    function t() {
      (this.body = n("body")),
        ...
        (this.config = {}),
        (this.defaultBSStyle = n("#bootstrap-stylesheet")),
        (this.defaultAppStyle = n("#main-stylesheet")),
        (this.darkBSStyle = n("#bootstrap-dark-stylesheet")),
        (this.darkAppStyle = n("#main-dark-stylesheet"));
    }
    (t.prototype._saveConfig = function (t) {
      ...
      (t.prototype.loadConfig = function () {
        var t = JSON.parse(this.body.attr("data-layout") ? this.body.attr("data-layout") : "{}"),
          e = n.extend({}, { mode: "light", width: "fluid", menuPosition: "fixed", sidebar: { color: "light", size: "default", showuser: !1 }, topbar: { color: "dark" }, showRightSidebarOnPageLoad: !1 });
      ...
      (t.prototype.applyConfig = function () {
        (this.config = this.loadConfig()),
          ...
          this.topbar.init(),
          ((this.leftSidebar.parent = this).topbar.parent = this).changeMode(this.config.mode),
        ...
        switch (t) {
          case "dark":
            this.body.prepend(""),
              ...
              e && (this.leftSidebar.changeColor("dark"), this._saveConfig({ mode: t, sidebar: n.extend({}, this.config.sidebar, { color: "dark" }) })),
          ...
          default:
            this.body.css({ visibility: "hidden", opacity: 0 }),
              ...
              e && (this.leftSidebar.changeColor("light"), this._saveConfig({ mode: t, sidebar: n.extend({}, this.config.sidebar, { color: "light" }) })),
              this._saveConfig({ mode: t });
        }
      ...
      (t.prototype.changeMenuPositions = function (t) {
        this.body.attr("data-layout-menu-position", t), this._saveConfig({ menuPosition: t });
      }),
    ...
    (t.prototype.initControls = function () {
      ...
      (t.prototype.init = function () {
        ...
        window.sessionStorage &&
          ...
          (sessionStorage.getItem("_UBOLD_VISITED_") || (i.RightBar.toggleRightSideBar(), sessionStorage.setItem("_UBOLD_VISITED_", !0)));
        ...
        e &&
          ...
          document.getElementById("main-stylesheet").href.includes("rtl.min.css") && (document.getElementsByTagName("html")[0].dir = "rtl"),
          document.getElementById("main-dark-stylesheet").href.includes("rtl.min.css") && (document.getElementsByTagName("html")[0].dir = "rtl");
      }),
      (i.App = new t()),
      (i.App.Constructor = t);
  })(window.jQuery),
