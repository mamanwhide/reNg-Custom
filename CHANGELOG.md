...
* Fix #1234 paraKang unable to load celery tasks due to mismatched celery and redis versions
...
2.0.1 fixes a ton of issues in paraKang 2.0.
...
###  Added
 ...
 - Roles and Permissions: assign distinct roles to your team members: Sys Admin, Penetration Tester, and Auditor—each with precisely defined permissions to tailor their access and actions within the paraKang ecosystem.
 - GPT-powered Report Generation: With the power of OpenAI's GPT, paraKang now provides you with detailed vulnerability descriptions, remediation strategies, and impact assessments.
 ...
 - Expanding Target Concept: paraKang 2.0 now accepts IPs, URLS, etc as targets. (#678, #658) Excellent work by [@ocervell](https://github.com/ocervell)
 - A ton of refactoring on paraKang's core to improve scan efficiency. Massive kudos to [@ocervell](https://github.com/ocervell)
 ...
 - Group Scan Results: paraKang 2.0 allows to group of subdomains based on similar page titles and HTTP status, and also vulnerability grouping based on the same vulnerability title and severity.
 - Added Support for Nmap: paraKang 2.0 allows to run Nmap scripts and vuln scans on ports found by Naabu. [@ocervell](https://github.com/ocervell)
...
- Notify New Releases on paraKang if available
...
- Added option to delete all scan results or delete all screenshots inside Settings and paraKang settings
...
- paraKang will no longer store any recon data apart from that in Database, this includes sorted_subdomains list.txt or any json file
...
- Added script to uninstall paraKang
...
- Official Documentation(WIP): We often get asked on how to use paraKang. For long, we had no official documentation. Finally, I've worked on it and we have the official documentation at parakang.wiki
...
- Global Search: This feature has been one of the most requested features for paraKang. Now you can search all the subdomains, endpoints, and vulnerabilities.

- OneForAll Support: paraKang now supports OneForAll for subdomain discovery, it is currently in beta. I am working on how to integrate OneForAll APIKeys and Configuration files.
...
- Design Changes A lot of design changes has happened in paraKang. Some of which are:
